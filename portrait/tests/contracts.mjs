...
import { resolveCoupleState, GIRLFRIEND_PRESENCE, COUPLE_ACTIVITY, VISIT_WINDOWS } from '../js/couple.js';
...
for(const [date,time,presence] of [['2026-09-14','14:00:00','AWAY'],['2026-09-14','20:00:00','VISITING'],['2026-09-14','21:31:00','AWAY'],['2026-09-19','19:00:00','VISITING'],['2026-09-19','23:31:00','AWAY'],['2026-09-20','21:16:00','AWAY']]){at(time,date);assert.equal(resolveCoupleState().presence,presence,date+' '+time);}
...
at('21:50:00');{const life2=new LifeDirector(makeNav(),world);assert.equal(life2.schedule,'shower');assert.equal(life2.startGuitar(),'wash','The shower cannot be interrupted');}
