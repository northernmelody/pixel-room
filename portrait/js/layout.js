...
export const ITEMS = Object.freeze([
  ...
  item('bedroom.window','window-bedroom','bedroom',120,83,'卧室的窗。保留原有窗帘、窗框与窗台，冬天会结一层薄霜。'),
  item('bedroom.wardrobe','wardrobe','bedroom',19,104,'熟悉的衣柜。小人会在晚间休闲时自己来换衣服。'),
  item('bedroom.bed','bed','bedroom',53,120,'床、枕头、被子，以及床上的腊肠狗抱枕。抱枕和屋里的小狗是两个不同的小伙伴。'),
  item('bedroom.nightstand','nightstand','bedroom',94,121,'床头柜与夜灯。点击灯的位置，可以开关这盏灯。',{lampIndex:5}),
  item('bedroom.guitar','guitar','bedroom',113,130,'三首原创歌曲的木吉他。小人会自己取琴，到床边弹唱，再把它放回来。'),
  item('bedroom.clock','wallClock','bedroom',105,91,'原来的墙钟，也搬进了楼上的卧室。'),
  item('bedroom.boba','plush-boba','bedroom',49,86,'珍珠奶茶玩偶，卧室墙上的六位小伙伴之一。'),
  item('bedroom.avocado','plush-avocado','bedroom',65,86,'牛油果玩偶，保留原来的绿色像素。'),
  item('bedroom.bunny','plush-bunny','bedroom',81,86,'小兔玩偶，长长的耳朵。'),
  item('bedroom.orange','plush-orange','bedroom',49,103,'橘子玩偶，暖色的小小挂件。'),
  item('bedroom.octopus','plush-octopus','bedroom',65,102,'小章鱼玩偶，住在第二排。'),
  item('bedroom.ramen','plush-ramen','bedroom',81,102,'拉面玩偶，六个墙面玩偶全部保留。'),
  ...
  item('workspace.bookshelf','bookshelf','workspace',15,201,'书架里保留了两本信件书：给 MOMO 的信，以及 MOMO 的回信。',{content:'letters'}),
  ...
  item('workspace.desk','desk','workspace',39,203,'电脑、键盘、咖啡杯和台灯。点击电脑可以查看六个频道。',{lampIndex:4}),
  ...
  item('kitchen.door','exteriorDoor','kitchen',144,273,'通往庭院的木门。天气合适的傍晚，小人会自己出去荡秋千。'),
  item('kitchen.fridge','fridge','kitchen',16,302,'取食材、零食和饮水的冰箱。'),
  item('kitchen.cabinets','kitchenCabinets','kitchen',49,274,'厨房吊柜，猫咪也喜欢探索这里的高处。'),
  item('kitchen.potRack','potRack','kitchen',20,276,'原有的锅、锅铲和挂钩。'),
  item('kitchen.spiceShelf','spiceShelf','kitchen',19,291,'置物架与调料罐。'),
  item('kitchen.counter','kitchenCounter','kitchen',48,310,'操作台、灶台与水槽，小人在这里准备三餐。'),
  item('kitchen.plant','kitchenPlant','kitchen',92,294,'厨房的小盆栽，四季的叶色略有不同。'),
  item('kitchen.table','tableStools','kitchen',90,322,'餐桌和两张凳子。三餐与零食会在这里继续。'),
