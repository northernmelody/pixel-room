...
export class LifeDirector{
  ...
  blocked(){if(this.schedule==='sleep'||this.activity==='sleep'||this.pose==='sleep')return 'sleep';if(this.schedule==='call'||this.activity==='call')return 'call';if(this.schedule==='morning'||this.activity==='morning'||this.schedule==='shower'||this.activity==='shower'||['washHands','brush','shower'].includes(this.pose))return 'wash';return '';}
