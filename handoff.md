...
- Vercel Production：`https://pixel-room-eight.vercel.app`，本轮第二次部署（deployment `dpl_4iHNEY7oPcSfXPSNgUdB9H8Z9B5q`，`READY`），线上包含横版入口修复、竖版点击范围收束与第二批 6 项需求（含 Still here 改名与默认开启声音）。
