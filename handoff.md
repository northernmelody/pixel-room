...
- 墙面玩偶第 4 个由横版的橘子改为哈密瓜切片（`plush-orange` → `plush-melon`，像素矩阵画在 `portrait/js/art/generate.mjs`，沿用横版的「挂点 + 1px 描边」画法），点击提示改为「MOMO的黄瓜」；横版 `js/roomLayout.js` 未改动，基线哈希保持有效。
