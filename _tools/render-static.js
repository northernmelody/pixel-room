/* 离线渲染：Node 中加载 roomLayout.js，用缓冲区 ctx 渲染静态场景，输出卧室墙面 PNG
 * 用法: node _tools/render-static.js [out.png] */
'use strict';
const fs = require('fs');
const vm = require('vm');
...
// ---- 输出卧室墙面区域 PNG（放大 SC 倍）----
const outFile = process.argv[2] || '_shots/static-wall.png';
const SC = 4;
const rx = 0, ry = 40, rw = 80, rh = 90;
